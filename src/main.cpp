...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 180;	// stake age of full weight: 180d
unsigned int nStakeTargetSpacing = 30;			// 30 sec block spacing

int64 nChainStartTime = 1398816610;
...
const string strMessageMagic = "UniversityCoin Signed Message:\n";
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
	...
	if(nHeight > 685440 && nHeight < 720000)
		nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE2;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UniversityCoin
    bool fStrictPayToScriptHash = true; // Always active in UniversityCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UniversityCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1398816615;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1092912;
        ...
        assert(block.hashMerkleRoot == uint256("0xb2336a48671e2b0b25b66a7613a9b9e6e13801e1150b06e6af2a887af9f85442"));
